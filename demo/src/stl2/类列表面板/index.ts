...
import { renderArray, renderIf, useModelValue } from "mvr-helper"
import { useStrFilter, useValueCenterValue } from "../../util"
...
export default panelWith({
  ...
  children(operate, id, arg, size, div) {
    const modelList = useValueCenterValue(modelListStore)
